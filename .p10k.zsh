# Generated by Powerlevel10k configuration wizard on 2026-08-01 at 00:08 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=20  # keep trailing segments full (no gi/.. shortening)
