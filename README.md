...
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/bhataprameya/zsh-install/main/install.sh)"
```

Or with `wget`:

```bash
sh -c "$(wget -qO- https://raw.githubusercontent.com/bhataprameya/zsh-install/main/install.sh)"
```
...
```bash
NO_CHSH=1 sh -c "$(curl -fsSL https://raw.githubusercontent.com/bhataprameya/zsh-install/main/install.sh)"
```
...
```bash
sudo ALL_USERS=1 sh -c "$(curl -fsSL https://raw.githubusercontent.com/bhataprameya/zsh-install/main/install.sh)"
```
...
```bash
git clone https://github.com/bhataprameya/zsh-install.git
cd zsh-install
./install.sh
```
